...
ImageMagick has a list of utilities that can be used for different purposes. The following table presents a summary of those utilities.

| Utility | Use | Syntax | Man page | Full list of command options |
| --- | --- | --- | --- | --- |
| `convert` | Change img format, blur, crop, draw on, flip, merge, resample, and more. Writes output on a new file. | `convert [input-option] input-file [output-option] output-file` | [See man page](https://docs.oracle.com/cd/E88353_01/html/E37839/convert-1.html) | [ImageMagick convert](https://imagemagick.org/script/convert.php) |
| `identify` | Obtain information about an image. | `identify [options] input-file` | [See man page](https://docs.oracle.com/cd/E88353_01/html/E37839/identify-1.html) | [ImageMagick identify](http://imagemagick.org/script/identify.php) |
| `mogrify` | Resize an img, blur, crop, draw on, flip, merge, resample, and more. Re-writes original file. | | | |
| `composite` | Overlaps one image over another. | | | |
| `montage` | Combines different images, adds border, frame, and much more. | | | |
| `compare` | Compare two images. | | | |
| `stream` | Writes the pixel components of an img a row at a time into different storage formats. | | | |
| `display` | Displays an image or image sequence. | | | |
| `animate` | Animates an image sequence. | | | |
| `import` | Saves  any  visible  window as an img file. Captures a single window, the entire screen, or any rectangular portion of the screen. | | | |
